...
const { Client } = require('pg');
    ...
    const createParcelTableQuery = `CREATE TABLE IF NOT EXISTS 
    ...
    // console.log(Database.instance)
      ...
      /*|| 'postgresql://kells:kells123@localhost:5432/sendit'; */

      let ins = new Client({ connectionString });
      ins.connect();

      let db = {
        query: (text, params) => ins.query(text, params),
      };
